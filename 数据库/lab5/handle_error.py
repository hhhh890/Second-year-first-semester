...
def handle_db_error(err: mysql.connector.Error, action_name: str = "Operation") -> dict:
    ...
    if err.errno == 1062: 
        ...
        elif 'friendgroup' in msg_lower: 
            return {"status": False, "msg": f"{action_name} failed: Group name already exists."}
        else:
        ...
        elif 'friendship' in msg_lower or 'friendgroup' in msg_lower or 'moment' in msg_lower:
